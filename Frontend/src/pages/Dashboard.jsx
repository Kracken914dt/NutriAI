      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
          <div className="flex justify-between items-start">
            <span className="text-on-surface-variant dark:text-tertiary-fixed-dim font-semibold text-sm">IMC (Masa Corporal)</span>
        ...
        <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
          <div className="flex justify-between items-start">
            <span className="text-on-surface-variant dark:text-tertiary-fixed-dim font-semibold text-sm">Consumo de Calorías</span>
          ...
          <div className="mt-4">
            ...
            <p className="text-xs text-on-surface-variant dark:text-tertiary-fixed-dim mt-1">Meta: {targetCalories} kcal</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
          <div className="flex justify-between items-start">
            <span className="text-on-surface-variant dark:text-tertiary-fixed-dim font-semibold text-sm">Health Score</span>
            <div className="p-2 bg-primary/10 rounded-lg">
        ...
        <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm flex flex-col justify-between hover:shadow-md transition-shadow">
          <div className="flex justify-between items-start">
            <span className="text-on-surface-variant dark:text-tertiary-fixed-dim font-semibold text-sm">Peso Actual</span>
          ...
          <div className="mt-4">
            ...
            <p className="text-xs text-on-surface-variant dark:text-tertiary-fixed-dim mt-1">Objetivo: {targetWeight} kg</p>
          </div>
        </div>
      </section>
        ...
        <div className="lg:col-span-2 bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-xs text-on-surface-variant dark:text-tertiary-fixed-dim">Últimos 7 días de consumo vs Meta diaria</p>
            </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              <div className="flex justify-between text-xs font-semibold mb-2">
                <span>Proteínas</span>
                <span className="text-on-surface-variant dark:text-tertiary-fixed-dim">{proteinLogged}g / {proteinGoal}g</span>
              </div>
            ...
            <div>
              <div className="flex justify-between text-xs font-semibold mb-2">
                ...
                <span className="text-on-surface-variant dark:text-tertiary-fixed-dim">{carbsLogged}g / {Math.round(weight * 3)}g</span>
              </div>
              <div className="w-full bg-surface-container h-2.5 rounded-full overflow-hidden">
                <div 
            ...
            <div>
              <div className="flex justify-between text-xs font-semibold mb-2">
                <span>Grasas</span>
                <span className="text-on-surface-variant dark:text-tertiary-fixed-dim">{fatsLogged}g / {Math.round(weight * 0.8)}g</span>
              </div>
              <div className="w-full bg-surface-container h-2.5 rounded-full overflow-hidden">
                <div 
        ...
        <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="text-xs text-on-surface-variant dark:text-tertiary-fixed-dim mb-6">Registra tu ingesta de agua hoy (vasos de 250ml)</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center py-4">
            ...
            <p className="text-xl font-bold text-center mb-6">
              {waterGlasses} / 8 <span className="text-sm font-normal text-on-surface-variant dark:text-tertiary-fixed-dim">vasos ({waterGlasses * 250} ml)</span>
            </p>
            ...
            <div className="flex gap-4 w-full">
              ...
              <button 
                ...
                className="border border-outline-variant hover:bg-slate-50 dark:hover:bg-slate-900 text-on-surface-variant dark:text-tertiary-fixed-dim py-2 px-3 rounded-xl text-xs transition-colors"
              >
                Reiniciar
              </button>
            </div>
