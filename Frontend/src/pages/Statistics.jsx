    ...
    <div className="space-y-8">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
          ...
          <div>
            <p className="text-[10px] uppercase font-bold text-tertiary dark:text-white">Promedio Calórico Semanal</p>
            <h4 className="font-headline text-2xl font-bold mt-1">{avgCalories} kcal / día</h4>
            <p className="text-[10px] text-tertiary dark:text-white mt-0.5">Meta establecida: {targetCalories} kcal</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
          ...
          <div>
            <p className="text-[10px] uppercase font-bold text-tertiary dark:text-white">Relación Peso / Meta</p>
            <h4 className="font-headline text-2xl font-bold mt-1">{weight} kg</h4>
            <p className="text-[10px] text-tertiary dark:text-white mt-0.5">Objetivo preventivo: {targetWeight} kg</p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm flex items-center gap-4 hover:shadow-md transition-shadow">
          ...
          <div>
            <p className="text-[10px] uppercase font-bold text-tertiary dark:text-white">Promedio de Macronutrientes</p>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm">
          <div className="mb-6">
            ...
            <p className="text-xs text-tertiary dark:text-white">Historial de energía absorbida comparada con el límite metabólico</p>
          </div>
        ...
        <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm">
          <div className="mb-6">
            ...
            <p className="text-xs text-tertiary dark:text-white">Distribución diaria de Proteínas, Carbohidratos y Grasas (g)</p>
          </div>
          <div className="h-72 w-full">
            <ResponsiveContainer width="100%" height="100%">
