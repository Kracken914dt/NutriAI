          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-1 mt-0.5">
                ...
                <span className="text-[10px] uppercase font-bold text-on-surface-variant dark:text-tertiary-fixed-dim">Online & Analizando Perfil</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-3xl mx-auto pointer-events-auto">
            ...
            <div className="flex flex-wrap gap-2 mb-4 justify-center">
              {suggestionChips.map((chip, i) => (
                <button
                  ...
                  className="px-3.5 py-1.5 rounded-full bg-white dark:bg-slate-800 border border-outline-variant/30 text-on-surface-variant dark:text-tertiary-fixed-dim font-bold text-xs hover:bg-primary-container/20 hover:text-primary transition-all shadow-sm active:scale-95 disabled:opacity-50"
                >
                  {chip}
                </button>
              ))}
            ...
            <div className="relative glass-card rounded-2xl p-2 flex items-center shadow-lg border border-primary/20">
              <input
                type="text"
                disabled={sending}
                className="flex-grow bg-transparent border-none focus:ring-0 text-sm px-4 text-on-surface dark:text-white placeholder:text-on-surface-variant/50"
          ...
          {userProfile ? (
            <div className="space-y-6">
              <div className="bg-surface-container-low dark:bg-slate-800 p-4 rounded-2xl border border-outline-variant/10">
                <p className="text-[10px] uppercase font-bold tracking-wider text-on-surface-variant dark:text-tertiary-fixed-dim">Salud Basal</p>
            ...
            <p className="text-xs text-on-surface-variant">Cargando perfil...</p>
          )}
        </div>

        <div className="border-t border-outline-variant/10 pt-6">
          <button className="w-full flex items-center justify-center gap-2 border border-outline-variant py-2.5 rounded-xl text-on-surface-variant dark:text-tertiary-fixed-dim font-bold text-xs hover:bg-slate-50 dark:hover:bg-slate-900 transition-all">
