    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center flex-wrap gap-4">
        <div>
          ...
          <p className="text-xs text-on-surface-variant">Configura tus variables fisiológicas básicas</p>
        </div>
        {!isEditing && (
          <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <section className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm text-center">
            ...
            <p className="text-xs text-on-surface-variant dark:text-tertiary-fixed-dim uppercase font-bold tracking-wider mt-1">{profile?.email}</p>
            <div className="mt-6 pt-6 border-t border-outline-variant/20 grid grid-cols-2 gap-4 text-center">
              <div>
                <p className="text-[10px] text-on-surface-variant dark:text-tertiary-fixed-dim uppercase font-bold">Actividad</p>
                <p className="text-sm font-semibold capitalize mt-1">{profile?.activity_level}</p>
              </div>
              <div>
                <p className="text-[10px] text-on-surface-variant dark:text-tertiary-fixed-dim uppercase font-bold">Dieta</p>
          ...
          <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm flex items-start gap-4">
            ...
            <div>
              <p className="text-xs text-on-surface-variant dark:text-tertiary-fixed-dim font-bold">Diagnóstico de Peso (IMC)</p>
              <h5 className="font-headline text-lg font-bold mt-1">{bmi} <span className="text-xs text-primary font-bold">({bmiCategory})</span></h5>
              <p className="text-xs text-on-surface-variant dark:text-tertiary-fixed-dim mt-2 leading-relaxed">{bmiDesc}</p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-sm">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] uppercase font-bold text-on-surface-variant dark:text-tertiary-fixed-dim">Nombre</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] uppercase font-bold text-on-surface-variant dark:text-tertiary-fixed-dim">Edad</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] uppercase font-bold text-on-surface-variant dark:text-tertiary-fixed-dim">Peso Actual</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] uppercase font-bold text-on-surface-variant dark:text-tertiary-fixed-dim">Estatura</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] uppercase font-bold text-on-surface-variant dark:text-tertiary-fixed-dim">Nivel de Actividad</p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-[10px] uppercase font-bold text-on-surface-variant dark:text-tertiary-fixed-dim">Peso Objetivo</p>
