        ...
        {loading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-sm border-collapse">
              <thead>
                <tr className="bg-surface-container-low dark:bg-surface-container-lowest text-tertiary dark:text-white uppercase font-bold text-[10px] tracking-wider border-b border-outline-variant/20">
                ...
                {meals.map((meal) => {
                  ...
                  return (
                    <tr key={meal.id} className="hover:bg-slate-50 dark:hover:bg-slate-900 transition-colors">
                      ...
                      <td className="py-4 px-6 text-center text-xs text-tertiary dark:text-tertiary-fixed-dim">
                        {isToday ? 'Hoy, ' : ''}
