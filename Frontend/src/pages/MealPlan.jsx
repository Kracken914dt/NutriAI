    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center flex-wrap gap-4">
        <div>
          ...
          <p className="text-xs text-tertiary dark:text-white">Menú semanal personalizado de grado clínico generado por IA</p>
        </div>
        <button
          ...
          <button
            ...
            className={`
              ...
              ${activeDay === day 
                ...
                : 'text-tertiary dark:text-white hover:bg-slate-100 dark:hover:bg-slate-900'
              }
            `}
          >
            {day}
      ...
      {activePlanDay ? (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white dark:bg-on-tertiary-fixed p-5 rounded-2xl border border-outline-variant/20 shadow-sm flex items-start gap-4 hover:shadow-md transition-shadow">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-tertiary dark:text-white mt-2 leading-relaxed font-semibold">{activePlanDay.desayuno?.name}</p>
                <div className="flex gap-4 mt-3 text-[10px] text-tertiary dark:text-white font-bold">
            ...
            <div className="bg-white dark:bg-on-tertiary-fixed p-5 rounded-2xl border border-outline-variant/20 shadow-sm flex items-start gap-4 hover:shadow-md transition-shadow">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-tertiary dark:text-white mt-2 leading-relaxed font-semibold">{activePlanDay.almuerzo?.name}</p>
                <div className="flex gap-4 mt-3 text-[10px] text-tertiary dark:text-white font-bold">
            ...
            <div className="bg-white dark:bg-on-tertiary-fixed p-5 rounded-2xl border border-outline-variant/20 shadow-sm flex items-start gap-4 hover:shadow-md transition-shadow">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-tertiary dark:text-white mt-2 leading-relaxed font-semibold">{activePlanDay.cena?.name}</p>
                <div className="flex gap-4 mt-3 text-[10px] text-tertiary dark:text-white font-bold">
            ...
            <div className="bg-white dark:bg-on-tertiary-fixed p-5 rounded-2xl border border-outline-variant/20 shadow-sm flex items-start gap-4 hover:shadow-md transition-shadow">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-tertiary dark:text-white mt-2 leading-relaxed font-semibold">{activePlanDay.snack?.name}</p>
                <div className="flex gap-4 mt-3 text-[10px] text-tertiary dark:text-white font-bold">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-on-tertiary-fixed p-6 rounded-2xl border border-outline-variant/30 shadow-sm space-y-6">
              <div>
                <p className="text-xs text-tertiary dark:text-white font-bold">Energía Total Proyectada</p>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-xs font-semibold mb-2">
                    ...
                    <span className="text-tertiary dark:text-white">{activePlanDay.totals?.proteins}g</span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between text-xs font-semibold mb-2">
                    ...
                    <span className="text-tertiary dark:text-white">{activePlanDay.totals?.carbs}g</span>
                  </div>
                  <div className="w-full bg-surface-container h-2 rounded-full overflow-hidden">
                ...
                <div>
                  <div className="flex justify-between text-xs font-semibold mb-2">
                    ...
                    <span className="text-tertiary dark:text-white">{activePlanDay.totals?.fats}g</span>
                  </div>
                  <div className="w-full bg-surface-container h-2 rounded-full overflow-hidden">
              ...
              <div className="border-t border-outline-variant/10 pt-4 text-xs text-tertiary dark:text-white space-y-2">
        ...
        <div className="p-12 text-center text-tertiary dark:text-white">Generando plan nutricional...</div>
      )}
    </div>
  );
};
