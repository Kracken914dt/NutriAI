      ...
      <main className="flex-grow">
            ...
            <div className="relative mt-8 lg:mt-0">
              ...
              <div className="glass-card p-4 rounded-3xl relative">
                ...
                <div className="absolute -bottom-6 -left-6 glass-card p-6 rounded-2xl hidden md:block max-w-[240px]">
                  ...
                  <p className="text-xs text-on-surface-variant font-medium">+15% mejora esta semana</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="beneficios" className="py-16 px-6 md:px-12 max-w-[1440px] mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-on-surface-variant max-w-xl mx-auto">Nutrición basada en ciencia y respaldada por profesionales.</p>
          </div>
            ...
            <div className="glass-card p-8 md:p-10 rounded-[32px]">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-on-surface-variant">Especialista en Endocrinología</p>
                </div>
              </div>
            </div>
            ...
            <div className="glass-card p-8 md:p-10 rounded-[32px]">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-on-surface-variant">Triatleta Profesional</p>
                </div>
              </div>
            </div>
          </div>
