    ...
    <div className="bg-background dark:bg-on-tertiary-fixed text-on-surface dark:text-white min-h-screen flex">
      ...
      `}>
        <div className="px-4 py-8">
          ...
          <p className="text-xs text-green-400 dark:text-tertiary-fixed-dim opacity-70 font-semibold uppercase tracking-wider">Prevención y Longevidad</p>
        </div>
              ...
              <NavLink
                ...
                className={`
                  ...
                  ${isActive 
                    ...
                    : 'text-green-200 dark:text-tertiary-fixed-dim hover:bg-primary/5 hover:text-primary'
                  }
                `}
              >
                <Icon size={18} />
      ...
      <div className="flex-1 md:ml-[280px] flex flex-col min-h-screen">
        ...
        <header className="sticky top-0 z-30 bg-white/70 dark:bg-on-tertiary-fixed/70 backdrop-blur-md h-20 px-6 md:px-12 flex items-center justify-between border-b border-outline-variant/30">
          ...
          <div className="flex items-center gap-6">
            <button className="relative p-2 text-green-400 dark:text-tertiary-fixed-dim hover:bg-surface-container rounded-full transition-colors">
              <Bell size={20} />
